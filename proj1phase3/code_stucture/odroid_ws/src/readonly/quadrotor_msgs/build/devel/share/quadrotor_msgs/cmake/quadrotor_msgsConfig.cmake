...
if("TRUE" STREQUAL "TRUE")
  set(quadrotor_msgs_SOURCE_PREFIX /home/odroid/odroid_ws/src/quadrotor_msgs)
  set(quadrotor_msgs_DEVEL_PREFIX /home/odroid/odroid_ws/src/quadrotor_msgs/build/devel)
...
if(NOT "/home/odroid/odroid_ws/src/quadrotor_msgs/build/devel/include " STREQUAL " ")
  set(quadrotor_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/odroid/odroid_ws/src/quadrotor_msgs/build/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'quadrotor_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Kartik Mohta <todo@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'quadrotor_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/odroid/odroid_ws/src/quadrotor_msgs/${idir}'.  Ask the maintainer 'Kartik Mohta <todo@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/odroid/odroid_ws/src/quadrotor_msgs/build/devel/lib;/opt/ros/jade/lib)
...
set(quadrotor_msgs_EXPORTED_TARGETS "quadrotor_msgs_generate_messages_cpp;quadrotor_msgs_generate_messages_eus;quadrotor_msgs_generate_messages_lisp;quadrotor_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${quadrotor_msgs_dep}_FOUND)
      find_package(${quadrotor_msgs_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${quadrotor_msgs_dep} REQUIRED ${depend_list})
  endif()
