                        ...
                        )
{
	...
	double r_acc[3];
	r_acc[0] = des_acc[0] + K_dx * (des_vel[0] - now_vel[0]) + K_px * (des_pos[0] - now_pos[0]);
	r_acc[1] = des_acc[1] + K_dy * (des_vel[1] - now_vel[1]) + K_py * (des_pos[1] - now_pos[1]); 
	r_acc[2] = des_acc[2] + K_dz * (des_vel[2] - now_vel[2]) + K_pz * (des_pos[2] - now_pos[2]);
